...
const CTASection = () => {
  return (
    <section className="bg-black relative overflow-hidden min-h-[700px] px-6 py-20">
      <div 
      ...
      />
      <div className="max-w-4xl mx-auto relative z-20 h-full flex flex-col justify-end pb-12 sm:pb-16 lg:pb-20">
        {/* CTA Buttons */}
