...
const SolanaWalletAuth: React.FC<SolanaWalletAuthProps> = ({
  ...
  if (user) {
    return <Button onClick={() => navigate('/track')} className={className} variant="hero-primary" size="lg">
  ...
  return <>
      ...
      <ProfileCreationModal isOpen={showProfileModal} onClose={() => setShowProfileModal(false)} onProfileCreated={handleProfileCreated} />
    </>;
};
