...
const FAQ = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer: "You earn tokens by completing verified vaping sessions. Each detected puff contributes to your score, and rewards are automatically calculated and distributed to your connected wallet based on your activity level."
    },
    {
